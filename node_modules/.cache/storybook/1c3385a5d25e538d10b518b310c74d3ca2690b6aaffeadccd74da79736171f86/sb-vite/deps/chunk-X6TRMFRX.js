...
var mr = Le((Ei, bt2) => {
  ...
  function gt2(e7, r, t) {
    if (typeof r != "string") {
      ...
      for (var i = dt2(e7), s4 = dt2(r), u = 0; u < o.length; ++u) {
        var c = o[u];
...
a(tt, "compile");
function He(e7, r, t, n, o, i, s4, u, c) {
            ...
            if (ue(N = et(S, r, t, d, f, o, u, A, T = [], C = [], l), i), E === 123)
              if (f === 0)
                ...
                switch (p === 99 && _(S, 3) === 110 ? 100 : p) {
                  ...
                  case 109:
                  case 115:
                    He(e7, N, N, n && ue(et(e7, N, N, 0, 0, o, u, A, o, T = [], l), C), o, C, l, u, n ? T : C);
                    break;
                  default:
                    He(S, N, N, N, [""], C, 0, u, C);
                }
...
a(He, "parse");
function et(e7, r, t, n, o, i, s4, u, c, d, f) {
  for (var l = o - 1, p = o === 0 ? i : [""], v = se(p), h = 0, m = 0, y = 0; h < n; ++h)
    for (var x = 0, E = q(e7, l + 1, l = Ur(m = s4[h])), A = e7; x < v; ++x)
      (A = je(m > 0 ? p[x] + " " + E : w(E, /&\f/g, p[x]))) && (c[y++] = A);
  return Oe(e7, r, t, o === 0 ? oe : u, c, d, f);
}
a(et, "ruleset");
function Jn(e7, r, t) {
...
function ut(e7, r) {
  switch (Yr(e7, r)) {
    ...
    case 6968:
    case 2756:
      return O2 + e7 + we + e7 + k + e7 + e7;
    case 6828:
    case 4268:
      return O2 + e7 + k + e7 + e7;
    case 6165:
      return O2 + e7 + k + "flex-" + e7 + e7;
    case 5187:
      return O2 + e7 + w(e7, /(\w+).+(:[^]+)/, O2 + "box-$1$2" + k + "flex-$1$2") + e7;
    case 5443:
      return O2 + e7 + k + "flex-item-" + w(e7, /flex-|-self/, "") + e7;
    case 4675:
      return O2 + e7 + k + "flex-line-pack" + w(e7, /align-content|flex-|-self/, "") + e7;
    case 5548:
      return O2 + e7 + k + w(e7, "shrink", "negative") + e7;
    case 5292:
      return O2 + e7 + k + w(e7, "basis", "preferred-size") + e7;
    case 6060:
      return O2 + "box-" + w(e7, "-grow", "") + O2 + e7 + k + w(e7, "grow", "positive") + e7;
    case 4554:
      return O2 + w(e7, /([^-])(transform)/g, "$1" + O2 + "$2") + e7;
    case 6187:
      return w(w(w(e7, /(zoom-|grab)/, O2 + "$1"), /(image-set)/, O2 + "$1"), e7, "") + e7;
    case 5495:
    case 3959:
      return w(e7, /(image-set\([^]*)/, O2 + "$1$`$1");
    case 4968:
      return w(w(e7, /(.+:)(flex-)?(.*)/, O2 + "box-pack:$3" + k + "flex-pack:$3"), /s.+-b[^;]+/, "justify") + O2 + e7 + e7;
    case 4095:
    case 3583:
    case 4068:
    case 2532:
      return w(e7, /(.+)-inline(.+)/, O2 + "$1$2") + e7;
    case 8116:
    case 7059:
    case 5753:
    case 5535:
    ...
    case 4765:
      if (P(e7) - 1 - r > 6) switch (_(e7, r + 1)) {
        ...
        case 102:
          return w(e7, /(.+:)(.+)-([^]+)/, "$1" + O2 + "$2-$3$1" + we + (_(e7, r + 3) == 108 ? "$3" : "$2-$3")) + e7;
        case 115:
    ...
    case 6444:
      switch (_(e7, P(e7) - 3 - (~Se(e7, "!important") && 10))) {
        case 107:
          return w(e7, ":", ":" + O2) + e7;
        case 101:
          return w(e7, /(.+:)([^;!]+)(;|!.+)?/, "$1" + O2 + (_(e7, 14) === 45 ? "inline-" : "") + "box$3$1" + O2 + "$2$3$1" + k + "$2box$3") + e7;
      }
      break;
    case 5936:
      switch (_(e7, r + 11)) {
        case 114:
          return O2 + e7 + k + w(e7, /[svh]\w+-[tblr]{2}/, "tb") + e7;
        case 108:
          return O2 + e7 + k + w(e7, /[svh]\w+-[tblr]{2}/, "tb-rl") + e7;
        case 45:
          return O2 + e7 + k + w(e7, /[svh]\w+-[tblr]{2}/, "lr") + e7;
      }
      return O2 + e7 + k + e7 + e7;
  }
  return e7;
...
function Fe(e7, r, t, n) {
  if (n === void 0 && (n = Da), r === 0)
    return n(t, t, t);
  var o = (e7 % 360 + 360) % 360 / 60, i = (1 - Math.abs(2 * t - 1)) * r, s4 = i * (1 - Math.abs(o % 2 - 1)), u = 0, c = 0, d = 0;
  ...
  (function(e7) {
    ...
    return a2(function n(o, i, l) {
      ...
      o.exports = function(d) {
        ...
        return function(v) {
          var b = a2(function() {
            var m = h, g7, y, w5 = arguments.length - 1, D7 = Array(w5 + 1), x = true, C;
            ...
            return x && (m.has(arguments[w5]) ? y = m.get(arguments[w5]) : x = false), x || (y = v.apply(null, arguments), m.set(arguments[w5], y)), d > 0 && (D7[w5] = {
              cacheItem: m,
              arg: arguments[w5]
            }, x ? u(f, D7) : f.push(D7), f.length > d && c(f.shift())), b.wasMemoized = x, b.numArgs = w5 + 1, y;
          }, "memoizerific");
...
function yr2(e7) {
  var t = e7.node, r = e7.stylesheet, n = e7.style, o = n === void 0 ? {} : n, i = e7.useInlineStyles, l = e7.key, u = t.properties, c = t.type, p = t.tagName, d = t.value;
  if (c === "text")
    return d;
  if (p) {
    var h = v6(r, i), f;
...
function x6(e7) {
  var t = e7.codeString, r = e7.codeStyle, n = e7.containerStyle, o = n === void 0 ? {
    float: "left",
    paddingRight: "10px"
  } : n, i = e7.numberStyle, l = i === void 0 ? {} : i, u = e7.startingLineNumber;
...
function li(e7) {
  var t = e7.children, r = e7.lineNumber, n = e7.lineNumberStyle, o = e7.largestLineNumber, i = e7.showInlineLineNumbers, l = e7.lineProps, u = l === void 0 ? {} : l, c = e7.className, p = c === void 0 ? [] : c, d = e7.showLineNumbers, h = e7.wrapLongLines, f = typeof u == "function" ? u(r) : u;
...
function E6(e7, t, r, n, o, i, l, u, c) {
  var p, d = $p(e7.value), h = [], f = -1, v = 0;
  function b(C, E) {
...
`)
        ...
        if (B6 === 0) {
          ...
          var L6 = d[v + 1] && d[v + 1].children && d[v + 1].children[0], P6 = {
            type: "text",
            value: "".concat(k4)
          };
          if (L6) {
            ...
            var N = [P6], G = g7(N, $6, E.properties.className);
            h.push(G);
          }
        } else {
          var z6 = [M6], K3 = g7(z6, $6, E.properties.className);
          h.push(K3);
        }
      }), f = v;
    }
  ...
  if (f !== d.length - 1) {
    ...
    if (w5 && w5.length) {
      var D7 = n && h.length + i, x = g7(w5, D7);
      h.push(x);
    }
  }
...
function Cs(e7, t) {
  return a2(function(n) {
    ...
    } : d, f = n.useInlineStyles, v = f === void 0 ? true : f, b = n.showLineNumbers, m = b === void 0 ? false : b, g7 = n.showInlineLineNumbers, y = g7 === void 0 ? true : g7, w5 = n.startingLineNumber, D7 = w5 === void 0 ? 1 : w5, x = n.lineNumberContainerStyle, C = n.lineNumberStyle, E = C === void 0 ? {} : C, S = n.wrapLines, R = n.wrapLongLines, A = R === void 0 ? false : R, k4 = n.lineProps, B6 = k4 === void 0 ? {} : k4, $6 = n.renderer, M6 = n.PreTag, W = M6 === void 0 ? "pre" : M6, T = n.CodeTag, L6 = T === void 0 ? "code" : T, P6 = n.code, U6 = P6 === void 0 ? (Array.isArray(i) ? i[0] : i) || "" : P6, N = n.astGenerator, G = mp(n, w6);
    N = N || e7;
    var z6 = m ? import_react4.default.createElement(x6, {
      ...
      codeString: U6
    }) : null, K3 = u.hljs || u['pre[class*="language-"]'] || {
      backgroundColor: "#fff"
    ...
    if (A ? h.style = mt(mt({}, h.style), {}, {
      ...
      return import_react4.default.createElement(W, ve2, z6, import_react4.default.createElement(L6, h, U6));
    (S === void 0 && $6 || A) && (S = true), $6 = $6 || S6;
    var de2 = [{
      type: "text",
      value: U6
    }], Ce2 = R6({
    ...
    var Le2 = Ce2.value.length + D7, Ie2 = E6(Ce2, S, B6, m, y, D7, Le2, E, A);
    return import_react4.default.createElement(W, ve2, import_react4.default.createElement(L6, h, !y && z6, $6({
      rows: Ie2,
      stylesheet: u,
      useInlineStyles: v
    })));
...
var Gp = _2((SH, Up) => {
  ...
  Up.exports = T6;
  function T6(e7) {
    for (var t = e7.length, r = [], n = [], o = -1, i, l; ++o < t; )
      i = e7[o], r.push(i.property), n.push(i.normal), l = i.space;
    return new k6(
      Wp.apply(null, r),
      Wp.apply(null, n),
      l
...
var cn2 = _2((_H, nd) => {
  ...
  nd.exports = P6;
  function P6(e7) {
    var t = e7.space, r = e7.mustUseProperty || [], n = e7.attributes || {}, o = e7.properties, i = e7.transform, l = {}, u = {}, c, p;
    for (c in o)
      p = new _6(
        c,
        i(n, c),
...
var Ed = _2((JH, Cd) => {
  ...
  var xd = /[#.]/g;
  function f7(e7, t) {
    for (var r = e7 || "", n = t || "div", o = {}, i = 0, l, u, c; i < r.length; )
...
var Fd = _2((Ms) => {
  ...
  var Bs = ",", Ad = " ", ra2 = "";
  function w7(e7) {
    for (var t = [], r = String(e7 || ra2), n = r.indexOf(Bs), o = 0, i = false, l; !i; )
...
var _d = _2((o$, Md) => {
  ...
  function C7(e7, t, r) {
    ...
    function i(l, u, c) {
      var p, d, h;
      c == null || c !== c || (p = y7(e7, u), d = p.property, h = c, typeof h == "string" && (p.spaceSeparated ? h = Td(h) : p.commaSeparated ? h = Ld(h) : p.commaOrSpaceSeparated && (h = Td(Ld(h).join(" ")))), d === "style" && typeof c != "string" && (h = A7(h)), d === "className" && l.className && (h = l.className.concat(h)), l[d] = R7(p, d, h));
    }
  }
  a2(C7, "factory");
  function E7(e7, t) {
...
var df = _2((y$, pf) => {
  ...
  a2(rw, "parseEntities");
  function nw(e7, t) {
    var r = t.additional, n = t.nonTerminated, o = t.text, i = t.reference, l = t.warning, u = t.textContext, c = t.referenceContext, p = t.warningContext, d = t.position, h = t.indent || [], f = e7.length, v = 0, b = -1, m = d.column || 1, g7 = d.line || 1, y = "", w5 = [], D7, x, C, E, S, R, A, k4, B6, $6, M6, W, T, L6, P6, U6, N, G, z6;
    for (typeof r == "string" && (r = r.charCodeAt(0)), U6 = K3(), k4 = l ? Te2 : W7, v--, f++; ++v < f; )
      if (S === tf && (m = h[b] || 1), S = e7.charCodeAt(v), S === rf) {
        if (A = e7.charCodeAt(v + 1), A === U7 || A === tf || A === G7 || A === X7 || A === rf || A === K7 || A !== A || r && A === r) {
          y += dn2(S), m++;
          continue;
        }
        for (T = v + 1, W = T, z6 = T, A === J7 ? (z6 = ++W, A = e7.charCodeAt(z6), A === Q7 || A === ew ? (L6 = Hs, z6 = ++W) : L6 = $s) : L6 = fn, D7 = "", M6 = "", E = "", P6 = di[L6], z6--; ++z6 < f && (A = e7.charCodeAt(z6), !!P6(A)); )
          E += dn2(A), L6 === fn && q7.call(Jd, E) && (D7 = E, M6 = Jd[E]);
        C = e7.charCodeAt(z6) === Y7, C && (z6++, x = L6 === fn ? V7(E) : false, x && (D7 = E, M6 = x)), G = 1 + z6 - T, !C && !n || (E ? L6 === fn ? (C && !M6 ? k4(uf, 1) : (D7 !== E && (z6 = W + D7.length, G = 1 + z6 - W, C = false), C || (B6 = D7 ? of : lf, t.attribute ? (A = e7.charCodeAt(z6), A === Z7 ? (k4(B6, G), M6 = null) : nf(A) ? M6 = null : k4(B6, G)) : k4(B6, G))), R = M6) : (C || k4(af, G), R = parseInt(E, zs[L6]), ow(R) ? (k4(cf, G), R = dn2(tw)) : R in Qd ? (k4(Ps, G), R = Qd[R]) : ($6 = "", aw(R) && k4(Ps, G), R > 65535 && (R -= 65536, $6 += dn2(R >>> 10 | 55296), R = 56320 | R & 1023), R = $6 + dn2(R))) : L6 !== fn && k4(sf, G)), R ? (ve2(), U6 = K3(), v = z6 - 1, m += z6 - T + 1, w5.push(R), N = K3(), N.offset++, i && i.call(
          c,
          R,
          { start: U6, end: N },
          e7.slice(T - 1, z6)
        ), U6 = N) : (E = e7.slice(T - 1, z6), y += E, m += E.length, v = z6 - 1);
      } else
        S === 10 && (g7++, b++, m = 0), S === S ? (y += dn2(S), m++) : ve2();
    return w5.join("");
    function K3() {
      return {
        line: g7,
    ...
    function ve2() {
      y && (w5.push(y), o && o.call(u, y, { start: U6, end: K3() }), y = "");
    }
  }
  a2(nw, "parse");
  function ow(e7) {
...
var hf = _2((x$, fi) => {
  ...
  var ff = function(e7) {
    var t = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, r = 0, n = {}, o = {
        ...
        clone: a2(function m(g7, y) {
          ...
          switch (o.util.type(g7)) {
            case "Object":
              ...
              {}, y[D7] = w5;
              for (var x in g7)
                g7.hasOwnProperty(x) && (w5[x] = m(g7[x], y));
              return (
                /** @type {any} */
                w5
              );
      ...
      languages: {
        ...
        insertBefore: a2(function(m, g7, y, w5) {
          ...
          var D7 = w5[m], x = {};
          for (var C in D7)
            if (D7.hasOwnProperty(C)) {
              if (C == g7)
                for (var E in y)
                  y.hasOwnProperty(E) && (x[E] = y[E]);
              y.hasOwnProperty(C) || (x[C] = D7[C]);
            }
          var S = w5[m];
        ...
        DFS: a2(function m(g7, y, w5, D7) {
          ...
          for (var C in g7)
            if (g7.hasOwnProperty(C)) {
              y.call(g7, C, g7[C], w5 || C);
              var E = g7[C], S = o.util.type(E);
              S === "Object" && !D7[x(E)] ? (D7[x(E)] = true, m(E, y, null, D7)) : S === "Array" && !D7[x(E)] && (D7[x(E)] = true, m(E, y, C, D7));
            }
        }, "DFS")
      },
      plugins: {},
      ...
      highlightAllUnder: a2(function(m, g7, y) {
        ...
        for (var D7 = 0, x; x = w5.elements[D7++]; )
          o.highlightElement(x, g7 === true, w5.callback);
      }, "highlightAllUnder"),
      /**
      ...
      tokenize: a2(function(m, g7) {
        ...
        var D7 = new c();
        return p(D7, D7.head, m), u(m, D7, g7, D7.head, 0), h(D7);
      }, "tokenize"),
      /**
       * @namespace
       * @memberof Prism
    ...
    a2(i, "Token"), i.stringify = a2(function m(g7, y) {
      ...
      x && (Array.isArray(x) ? Array.prototype.push.apply(D7.classes, x) : D7.classes.push(x)), o.hooks.run("wrap", D7);
      var C = "";
      for (var E in D7.attributes)
        C += " " + E + '="' + (D7.attributes[E] || "").replace(/"/g, "&quot;") + '"';
      return "<" + D7.tag + ' class="' + D7.classes.join(" ") + '"' + C + ">" + D7.content + "</" + D7.tag + ">";
    }, "stringify");
    function l(m, g7, y, w5) {
      m.lastIndex = g7;
      var D7 = m.exec(y);
      if (D7 && w5 && D7[1]) {
        var x = D7[1].length;
        D7.index += x, D7[0] = D7[0].slice(x);
      }
      return D7;
    }
    a2(l, "matchPattern");
    function u(m, g7, y, w5, D7, x) {
      for (var C in y)
        if (!(!y.hasOwnProperty(C) || !y[C])) {
          ...
          for (var S = 0; S < E.length; ++S) {
            if (x && x.cause == C + "," + S)
              return;
            var R = E[S], A = R.inside, k4 = !!R.lookbehind, B6 = !!R.greedy, $6 = R.alias;
            if (B6 && !R.pattern.global) {
              var M6 = R.pattern.toString().match(/[imsuy]*$/)[0];
              R.pattern = RegExp(R.pattern.source, M6 + "g");
            }
            for (var W = R.pattern || R, T = w5.next, L6 = D7; T !== g7.tail && !(x && L6 >= x.reach); L6 += T.value.length, T = T.next) {
              var P6 = T.value;
              ...
              if (!(P6 instanceof i)) {
                var U6 = 1, N;
                if (B6) {
                  if (N = l(W, L6, m, k4), !N || N.index >= m.length)
                    break;
                ...
                var Xo = new i(C, A ? o.tokenize(ve2, A) : ve2, $6, ve2);
                if (T = p(g7, Ie2, Xo), Ce2 && p(g7, T, Ce2), U6 > 1) {
                  var Yo = {
                    cause: C + "," + S,
                    reach: Le2
                  };
                  u(m, g7, y, T.prev, L6, Yo), x && Yo.reach > x.reach && (x.reach = Yo.reach);
                }
              }
            }
          }
    ...
    e7.languages.markup = {
      ...
      value: a2(function(r, n) {
        ...
        l[r] = {
          ...
          greedy: true,
          inside: i
        }, e7.languages.insertBefore("markup", "cdata", l);
      }, "addInlined")
...
var Ef = _2((I$, Cf) => {
  ...
  a2(oa2, "register");
  function hw(e7, t) {
    var r = ae2.languages, n = e7, o, i, l, u;
    t && (n = {}, n[e7] = t);
    for (o in n)
...
function zw(e7) {
  let [t, r] = _e2.useState(), n = _e2.useRef({}), o = _e2.useRef(e7), i = _e2.useRef("none"), l = e7 ? "mounted" : "unmounted", [u, c] = $w(l, {
    mounted: {
      UNMOUNT: "unmounted",
  ...
  return _e2.useEffect(() => {
    ...
    if (d !== e7) {
      ...
      e7 ? c("MOUNT") : v === "none" || (p == null ? void 0 : p.display) === "none" ? c("UNMOUNT") : c(d && f !== v ? "ANIMATION_OUT" : "UNMOUNT"), o.current = e7;
    }
  }, [e7, c]), ia2(() => {
    if (t) {
      let p = a2((h) => {
...
function Mh(e7, t = []) {
  ...
  function n(i, l) {
    ...
    r = [...r, l];
    function p(h) {
      let { scope: f, children: v, ...b } = h, m = (f == null ? void 0 : f[e7][c]) || u, g7 = Lt2.useMemo(() => b, Object.values(b));
      return (0, import_jsx_runtime3.jsx)(m.Provider, { value: g7, children: v });
    }
    a2(p, "Provider");
    function d(h, f) {
      let v = (f == null ? void 0 : f[e7][c]) || u, b = Lt2.useContext(v);
      if (b) return b;
...
function jh(e7, t, r = "ltr") {
  let n = yi(t), o = t.scrollbar.paddingStart + t.scrollbar.paddingEnd, i = t.scrollbar.size - o, l = t.content - t.viewport, u = i - n, c = r === "ltr" ? [0, l] : [l * -1, 0], p = zh(e7, c);
  return t5([0, l], [0, u])(p);
}
function t5(e7, t) {
  return (r) => {
...
var s5 = F2(() => {
  ...
  du = "ScrollArea", [qh, nO] = Mh(du), [Gw, Xe2] = qh(du), Wh = I2.forwardRef(
    (e7, t) => {
      let {
        __scopeScrollArea: r,
        type: n = "hover",
        ...
        ...l
      } = e7, [u, c] = I2.useState(null), [p, d] = I2.useState(null), [h, f] = I2.useState(null), [v, b] = I2.useState(null), [m, g7] = I2.useState(
        null
      ), [y, w5] = I2.useState(0), [D7, x] = I2.useState(0), [C, E] = I2.useState(false), [S, R] = I2.useState(false), A = Tt2(t, (B6) => c(B6)), k4 = Hh(
        o
      );
  ...
  Uh = "ScrollAreaViewport", Gh = I2.forwardRef(
    (e7, t) => {
      let { __scopeScrollArea: r, children: n, asChild: o, nonce: i, ...l } = e7, u = Xe2(Uh, r), c = I2.useRef(null), p = Tt2(t, c, u.onViewportChange);
...
`
  ...
  gt = "ScrollAreaScrollbar", Xh = I2.forwardRef(
    (e7, t) => {
      let { forceMount: r, ...n } = e7, o = Xe2(gt, e7.__scopeScrollArea), { onScrollbarXEnabledChange: i, onScrollbarYEnabledChange: l } = o, u = e7.orientation === "horizontal";
      return I2.useEffect(() => (u ? i(true) : l(true), () => {
        u ? i(false) : l(false);
      }), [u, i, l]), o.type === "hover" ? (0, import_jsx_runtime5.jsx)(Xw, { ...n, ref: t, forceMount: r }) : o.type === "scroll" ? (0, import_jsx_runtime5.jsx)(
        Yw,
  ...
  Xh.displayName = gt;
  Xw = I2.forwardRef((e7, t) => {
    let { forceMount: r, ...n } = e7, o = Xe2(gt, e7.__scopeScrollArea), [i, l] = I2.useState(false);
    return I2.useEffect(() => {
  ...
  }), Yw = I2.forwardRef((e7, t) => {
    let { forceMount: r, ...n } = e7, o = Xe2(gt, e7.__scopeScrollArea), i = e7.orientation === "horizontal", l = Di(() => c("SCROLL_END"), 100), [u, c] = qw("hidden", {
      hidden: {
        SCROLL: "scrolling"
      },
      scrolling: {
  ...
  }), Yh = I2.forwardRef((e7, t) => {
    let r = Xe2(gt, e7.__scopeScrollArea), { forceMount: n, ...o } = e7, [i, l] = I2.useState(false), u = e7.orientation === "horizontal", c = Di(() => {
      if (r.viewport) {
  ...
  }), fu = I2.forwardRef((e7, t) => {
    let { orientation: r = "vertical", ...n } = e7, o = Xe2(gt, e7.__scopeScrollArea), i = I2.useRef(null), l = I2.useRef(0), [u, c] = I2.useState(
      {
        content: 0,
        viewport: 0,
  ...
  }), Kw = I2.forwardRef((e7, t) => {
    let { sizes: r, onSizesChange: n, ...o } = e7, i = Xe2(gt, e7.__scopeScrollArea), [l, u] = I2.useState(), c = I2.useRef(null), p = Tt2(t, c, i.onScrollbarXChange);
    return I2.useEffect(() => {
      ...
      Zh,
      {
        ...
        onWheelScroll: a2((d, h) => {
          if (i.viewport) {
            ...
            e7.onWheelScroll(f), r5(f, h) && d.preventDefault();
          }
        }, "onWheelScroll"),
        onResize: a2(() => {
  ...
  }), Zw = I2.forwardRef((e7, t) => {
    let { sizes: r, onSizesChange: n, ...o } = e7, i = Xe2(gt, e7.__scopeScrollArea), [l, u] = I2.useState(), c = I2.useRef(null), p = Tt2(t, c, i.onScrollbarYChange);
    return I2.useEffect(() => {
      c.current && u(getComputedStyle(c.current));
    }, [c]), (0, import_jsx_runtime5.jsx)(
      Zh,
  ...
  }), [Jw, Kh] = qh(gt), Zh = I2.forwardRef((e7, t) => {
    let {
      __scopeScrollArea: r,
      sizes: n,
      hasThumb: o,
      ...
      onResize: h,
      ...f
    } = e7, v = Xe2(gt, r), [b, m] = I2.useState(null), g7 = Tt2(t, (A) => m(A)), y = I2.useRef(null), w5 = I2.useRef(""), D7 = v.viewport, x = n.content - n.viewport, C = Jt2(d), E = Jt2(c), S = Di(h, 10);
    function R(A) {
      if (y.current) {
    ...
    return a2(R, "handleDragScroll"), I2.useEffect(() => {
      let A = a2((k4) => {
        let B6 = k4.target;
        (b == null ? void 0 : b.contains(B6)) && C(k4, x);
      }, "handleWheel");
      return document.addEventListener("wheel", A, { passive: false }), () => document.removeEventListener("wheel", A, { passive: false });
    }, [D7, b, x, C]), I2.useEffect(E, [n, E]), vn2(b, S), vn2(v.content, S), (0, import_jsx_runtime5.jsx)(
      Jw,
      {
        scope: r,
        scrollbar: b,
    ...
    (e7, t) => {
      let { __scopeScrollArea: r, style: n, ...o } = e7, i = Xe2(wi, r), l = Kh(wi, r), { onThumbPositionChange: u } = l, c = Tt2(
        t,
        (h) => l.onThumbChange(h)
      ), p = I2.useRef(), d = Di(() => {
  ...
  Qh.displayName = hu;
  eb = I2.forwardRef((e7, t) => {
    let { __scopeScrollArea: r, ...n } = e7, o = Xe2(hu, r), [i, l] = I2.useState(0), [u, c] = I2.useState(0), p = !!(i && u);
  ...
  rb = a2((e7, t = () => {
    ...
    return a2(function o() {
      let i = { left: e7.scrollLeft, top: e7.scrollTop }, l = r.left !== i.left, u = r.top !== i.top;
...
var Ci = F2(() => {
  ...
  ib = Tr(n5)(
    ...
    ({ children: e7, horizontal: t = false, vertical: r = false, offset: n = 2, scrollbarSize: o = 6, className: i }, l) => import_react6.default.createElement(
      ib,
      { scrollbarsize: o, offset: n, className: i },
      import_react6.default.createElement(lb, { ref: l }, e7),
...
function ZC(e7) {
  let t = e7.length, r, n, o, i, l, u = 0, c;
  function p(v) {
    let b, m = v.exec(e7.substring(u));
  ...
  function h() {
    for (p(UC), o = "", i = "in descriptor"; ; ) {
      if (l = e7.charAt(u), i === "in descriptor") if (C5(l)) o && (n.push(o), o = "", i = "after descriptor");
      else if (l === ",") {
        u += 1, o && n.push(o), f();
        return;
  ...
  a2(h, "f");
  function f() {
    let v = false, b, m, g7, y, w5 = {}, D7, x, C, E, S;
    for (y = 0; y < n.length; y++) D7 = n[y], x = D7[D7.length - 1], C = D7.substring(0, D7.length - 1), E = parseInt(C, 10), S = parseFloat(C), E5.test(C) && x === "w" ? ((b || m) && (v = true), E === 0 ? v = true : b = E) : KC.test(C) && x === "x" ? ((b || m || g7) && (v = true), S < 0 ? v = true : m = S) : E5.test(C) && x === "h" ? ((g7 || m) && (v = true), E === 0 ? v = true : g7 = E) : v = true;
    if (!v) w5.source = { value: r, startOffset: c }, b && (w5.width = { value: b }), m && (w5.density = { value: m }), g7 && (w5.height = { value: g7 }), d.push(w5);
...
function tE(e7) {
  let t = JC(e7), r = eE.filter((d) => t.some((h) => Object.prototype.hasOwnProperty.call(h, d)));
  if (r.length > 1) throw new Error("Mixed descriptor in srcset is not supported");
  let [n] = r, o = D2[n], i = t.map((d) => d.source.value), l = Math.max(...i.map((d) => d.length)), u = t.map((d) => d[n] ? String(d[n].value) : ""), c = u.map((d) => {
    let h = d.indexOf(".");
...
async function sE(e7, t, r, n) {
  let o = or2(r.node), { left: i, operator: l, right: u } = uE(o), c = fc(r, n);
  return [ue2(await at2(`function _(${i}) {}`, e7, { parser: c ? "babel-ts" : "babel", __isVueForBindingLeft: true })), " ", l, " ", await at2(
    u,
    e7,
...
function DE(e7, t, r) {
  ...
  let i = ((n = o.prev) == null ? void 0 : n.type) === "comment" && yE(o.prev.value), l = typeof i == "boolean" ? () => i : Array.isArray(i) ? (h) => i.includes(h.rawName) : () => false, u = e7.map(({ node: h }) => l(h) ? ot2(t.originalText.slice(Ki(h), Zi(h))) : r(), "attrs"), c = o.type === "element" && o.fullName === "script" && o.attrs.length === 1 && o.attrs[0].fullName === "src" && o.children.length === 0, p = t.singleAttributePerLine && o.attrs.length > 1 && !eo2(o, t) ? Q2 : fe2, d = [bt([c ? " " : fe2, Jn2(p, u)])];
    ...
    case "element":
      ...
      if (!r.isSelfClosing && pc2(r, t)) {
        ...
        return n ? async (o, i) => {
          ...
          return u || (c = await o(i2(l), { parser: n, __embeddedInHtml: true }), u = c === ""), [Br(r, t), ue2(Zu(e7, t, i)), u ? "" : Q2, c, u ? "" : Q2, Ku(r, t), Lr2(r, t)];
        } : void 0;
      }
      break;
    case "text":
...
function iR(e7, t, r) {
  let [, n, o, i] = r, l = 4 + n.length, u = e7.sourceSpan.start.moveBy(l), c = u.moveBy(i.length), [p, d] = (() => {
    try {
...
function P2(e7, t, r) {
  ...
  if (n === "vue") {
    if (d.some((C) => C.type === "docType" && C.value === "html" || C.type === "element" && C.name.toLowerCase() === "html")) return P2(
      e7,
      $2,
      r
    );
    let w5, D7 = a2(() => w5 ?? (w5 = G5(e7, { canSelfClose: o, allowHtmComponentClosingTags: u, isTagNameCaseSensitive: c })), "y"), x = a2(
      (C) => D7().rootNodes.find(({ startSourceSpan: E }) => E && E.start.offset === C.startSourceSpan.start.offset) ?? C,
      "M"
    );
    for (let [C, E] of d.entries()) {
      let { endSourceSpan: S, startSourceSpan: R } = E;
      if (S === null) h = D7().errors, d[C] = x(E);
      else if (fR(E, r)) {
        let A = D7().errors.find((k4) => k4.span.start.offset > R.start.offset && k4.span.start.offset < S.end.offset);
        A && Y5(A), d[C] = x(E);
      }
    }
  }
  h.length > 0 && Y5(h[0]);
  let f = a2((w5) => {
    let D7 = w5.name.startsWith(":") ? w5.name.slice(1).split(":")[0] : null, x = w5.nameSpan.toString(), C = D7 !== null && x.startsWith(`${D7}:`), E = C ? x.slice(D7.length + 1) : x;
    w5.name = E, w5.namespace = D7, w5.hasExplicitNamespace = C;
  }, "d"), v = a2((w5) => {
    switch (w5.type) {
      case "element":
        f(w5);
    ...
    if (w5.type === "element" && (i && (!w5.namespace || w5.namespace === w5.tagDefinition.implicitNamespacePrefix || ba2(w5)) && (w5.name = b(
      w5.name,
      (D7) => uR.has(D7)
    )), l)) for (let D7 of w5.attrs) D7.namespace || (D7.name = b(D7.name, (x) => Yu.has(w5.name) && (Yu.get("*").has(x) || Yu.get(
      w5.name
    ).has(x))));
  }, "D"), g7 = a2((w5) => {
  ...
  return B2(new class extends kS {
    visitExpansionCase(w5, D7) {
      n === "angular" && this.visitChildren(D7, (x) => {
        x(w5.expression);
      });
    }
    visit(w5) {
      v(w5), y(w5), m(w5), g7(w5);
    }
  }(), d), d;
}
function fR(e7, t) {
...
function H22(e7, t, r = {}, n = true) {
  let { frontMatter: o, content: i } = n ? tR(e7) : { frontMatter: null, content: e7 }, l = new k2(e7, r.filepath), u = new Ju(l, 0, 0, 0), c = u.moveBy(e7.length), p = { type: "root", sourceSpan: new j2(u, c), children: P2(i, t, r) };
  if (o) {
    let f = new Ju(l, 0, 0, 0), v = f.moveBy(o.raw.length);
    o.sourceSpan = new j2(f, v), p.children.unshift(o);
  }
  let d = new rR(p), h = a2((f, v) => {
    let { offset: b } = v, m = Oe2(false, e7.slice(0, b), /[^\n\r]/gu, " "), g7 = H22(m + f, t, r, false);
    g7.sourceSpan = new j2(v, xa2(false, g7.children, -1).sourceSpan.end);
    let y = g7.children[0];
...
`);
  ...
  _22 = (rr = class {
    ...
    parse(t, r, n, o = false, i) {
      let l = a2((b) => (m, ...g7) => b(m.toLowerCase(), ...g7), "a"), u = o ? this.getTagDefinition : l(this.getTagDefinition), c = a2((b) => u(b).getContentType(), "u"), p = o ? i : l(i), d = _S(t, r, i ? (b, m, g7, y) => {
        let w5 = p(b, m, g7, y);
        return w5 !== void 0 ? w5 : c(b);
      } : c, n), h = n && n.canSelfClose || false, f = n && n.allowHtmComponentClosingTags || false, v = new XS(d.tokens, u, h, f, o);
...
`) {
    ...
    _consumeAttr(t) {
      ...
      return new RS(r, i, new j2(t.sourceSpan.start, n, t.sourceSpan.fullStart), t.sourceSpan, p, l.length > 0 ? l : void 0, void 0);
    }
    _consumeBlockOpen(t) {
      let r = [];
...
function IR(e7, t, r, n, o) {
  ...
  for (var u = 0, c = i.length, p = 0, d = 0; u < c; u++) {
    var h = i[u];
    if (h.removed) {
      if (h.value = e7.join(n.slice(d, d + h.count)), d += h.count, u && i[u - 1].added) {
        var f = i[u - 1];
        i[u - 1] = i[u], i[u] = f;
      }
    } else {
      ...
      } else h.value = e7.join(r.slice(p, p + h.count));
...
function Fc(e7, t, r, n, o) {
  ...
  if (_R.call(e7) === "[object Array]") {
    for (t.push(e7), l = new Array(e7.length), r.push(l), i = 0; i < e7.length; i += 1) l[i] = Fc(e7[i], t, r, n, o);
    return t.pop(), r.pop(), l;
  }
  if (e7 && e7.toJSON && (e7 = e7.toJSON()), nl(e7) === "object" && e7 !== null) {
    t.push(e7), l = {}, r.push(l);
    var u = [], c;
    for (c in e7) e7.hasOwnProperty(c) && u.push(c);
    for (u.sort(), i = 0; i < u.length; i += 1) c = u[i], l[c] = Fc(e7[c], t, r, n, c);
    t.pop(), r.pop();
  } else l = e7;
  return l;
}
...
function Lc(e7, t, r) {
  let n = t.type === "dedent" ? e7.queue.slice(0, -1) : [...e7.queue, t], o = "", i = 0, l = 0, u = 0;
...
function hl(e7, t) {
  let r = {}, n = t.printWidth, o = zc(t.endOfLine), i = 0, l = [{ ind: Mm(), mode: Pe, doc: e7 }], u = [], c = false, p = [], d = 0;
  for (cA(e7); l.length > 0; ) {
...
`, o) : b;
      ...
      case He2:
        switch (v) {
          ...
          case Pe: {
            ...
            if (!b.break && rl(m, l, g7, y, r)) l.push(m);
              ...
              if (b.break) {
                ...
                let x = b.expandedStates[D7], C = { ind: f, mode: yt2, doc: x };
                if (rl(C, l, g7, y, r)) {
                  l.push(C);
                  break;
                }
      ...
      case xt2: {
        ...
        let [y, w5] = g7, D7 = { ind: f, mode: yt2, doc: y }, x = { ind: f, mode: Pe, doc: y }, C = rl(D7, [], m, p.length > 0, r, true);
        if (g7.length === 1) {
          C ? l.push(D7) : l.push(x);
          break;
        }
        let E = { ind: f, mode: yt2, doc: w5 }, S = { ind: f, mode: Pe, doc: w5 };
        if (g7.length === 2) {
          C ? l.push(E, D7) : l.push(S, x);
          break;
        }
        g7.splice(0, 2);
        let R = { ind: f, mode: v, doc: Rm(g7) }, A = g7[0];
        rl({ ind: f, mode: yt2, doc: [y, w5, A] }, [], m, p.length > 0, r, true) ? l.push(R, E, D7) : C ? l.push(R, S, D7) : l.push(R, S, x);
        break;
      }
      case Ne2:
      case zt2: {
  ...
  return (t, r, n) => {
    ...
    for (; l >= 0 && l < i; ) {
      ...
      if (e7 instanceof RegExp) {
        if (!e7.test(u)) return l;
      } else if (!e7.includes(u)) return l;
      o ? l-- : l++;
    }
...
function Gc(e7, t) {
  ...
  if (!n) return [];
  let u = ((r == null ? void 0 : r(e7, t)) ?? [...Pm(e7, { getVisitorKeys: ml(o) })]).flatMap((c) => n(c) ? [c] : Gc(c, t));
  return u.sort((c, p) => i(c) - i(p) || l(c) - l(p)), xc.set(e7, u), u;
}
function Om(e7, t, r, n) {
  let { locStart: o, locEnd: i } = r, l = o(t), u = i(t), c = Gc(e7, r), p, d, h = 0, f = c.length;
  for (; h < f; ) {
    let v = h + f >> 1, b = c[v], m = o(b), g7 = i(b);
    if (m <= l && u <= g7) return Om(b, t, r, b);
    if (g7 <= l) {
      p = b, h = v + 1;
      continue;
    }
...
function MA(e7, t) {
  ...
  for (let [v, b] of f.entries()) {
    let { comment: m, precedingNode: g7, enclosingNode: y, followingNode: w5, text: D7, options: x, ast: C, isLastComment: E } = b;
    ...
    let S;
    if (l ? S = [b] : (m.enclosingNode = y, m.precedingNode = g7, m.followingNode = w5, S = [m, D7, x, C, E]), _A(D7, x, f, v)) m.placement = "ownLine", p(...S) || (w5 ? ro2(w5, m) : g7 ? no2(g7, m) : Pr2(y || C, m));
    else if (PA(D7, x, f, v)) m.placement = "endOfLine", d(...S) || (g7 ? no2(g7, m) : w5 ? ro2(w5, m) : Pr2(y || C, m));
    else if (m.placement = "remaining", !h(...S)) if (g7 && w5) {
      let R = n.length;
      R > 0 && n[R - 1].followingNode !== w5 && U2(n, x), n.push(b);
    } else g7 ? no2(g7, m) : w5 ? ro2(w5, m) : Pr2(y || C, m);
  }
...
function _A(e7, t, r, n) {
  ...
  if (i) for (let p = n - 1; p >= 0; p--) {
    ...
    if (h !== i || !Nm(e7.slice(u(d), c))) break;
    c = l(d);
  }
...
function PA(e7, t, r, n) {
  ...
  if (i) for (let p = n + 1; p < r.length; p++) {
    ...
    if (h !== i || !Nm(e7.slice(c, l(d)))) break;
    c = u(d);
  }
  return ar(e7, c);
}
function U2(e7, t) {
  ...
  let o = e7.length;
  if (o === 0) return;
  let { precedingNode: i, followingNode: l } = e7[0], u = t.locStart(l), c;
  for (c = o; c > 0; --c) {
    let { comment: p, precedingNode: d, followingNode: h } = e7[c - 1];
  ...
  for (let [p, { comment: d }] of e7.entries()) p < c ? no2(i, d) : ro2(l, d);
...
function $A(e7, t) {
  var r;
  let n = e7.node, o = [jm(e7, t)], { printer: i, originalText: l, locStart: u, locEnd: c } = t;
  if ((r = i.isBlockComment) != null && r.call(i, n)) {
    let d = ar(l, c(n)) ? ar(l, u(n), { backwards: true }) ? $r2 : Fm : " ";
    o.push(d);
  } else o.push($r2);
...
function zA(e7, t, r) {
  var n;
  let o = e7.node, i = jm(e7, t), { printer: l, originalText: u, locStart: c } = t, p = (n = l.isBlockComment) == null ? void 0 : n.call(l, o);
...
function OA(e7, t) {
  ...
  return e7.each(() => {
    ...
    c ? o.push($A(e7, t)) : p && (l = zA(e7, t, l), i.push(l.doc));
...
function Gm(e7, t) {
  ...
  let [r, n] = e7, [o, i] = e7.map((l) => l.split(`
`, 1)[0].length);
  return o > t && o > i ? n : r;
}
function eF(e7, t) {
  ...
  for (; h < o; ) for (l = t.charCodeAt(i + h), c = h++, u = h, d = 0; d < n; d++) p = l === Q22[d] ? c : c + 1, c = Sc[d], u = Sc[d] = c > u ? p > u ? u + 1 : p : p > c ? c + 1 : p;
  return u;
}
function rF(e7, t) {
...
function EF(e7, t, { logger: r = false, isCLI: n = false, passThrough: o = false, FlagSchema: i, descriptor: l } = {}) {
  if (n) {
  ...
  let u = o ? Array.isArray(o) ? (f, v) => o.includes(f) ? { [f]: v } : void 0 : (f, v) => ({ [f]: v }) : (f, v, b) => {
    ...
    return Xm(f, v, { ...b, schemas: g7 });
  }, c = SF(t, { isCLI: n, FlagSchema: i }), p = new CF(c, { logger: r, unknown: u, descriptor: l }), d = r !== false;
  d && Rc && (p._hasDeprecationWarned = Rc);
  let h = p.normalize(e7);
...
function RF(e7, { isCLI: t, optionInfos: r, FlagSchema: n }) {
  ...
  switch (e7.type) {
    ...
    case "string":
      ...
      break;
    case "choice":
      l = gF, i.choices = e7.choices.map((c) => c != null && c.redirect ? { ...c, redirect: { to: { key: e7.name, value: c.redirect } } } : c);
      break;
    case "boolean":
      l = lF;
      break;
  ...
  if (e7.exception ? i.validate = (c, p, d) => e7.exception(c) || p.validate(c, d) : i.validate = (c, p, d) => c === void 0 || p.validate(c, d), e7.redirect && (u.redirect = (c) => c ? { to: typeof e7.redirect == "string" ? e7.redirect : { key: e7.redirect.option, value: e7.redirect.value } } : void 0), e7.deprecated && (u.deprecated = true), t && !e7.array) {
    let c = i.preprocess || ((p) => p);
    i.preprocess = (p, d, h) => d.preprocess(c(Array.isArray(p) ? he2(false, p, -1) : p), h);
  }
  return e7.array ? iF.create({ ...t ? { preprocess: a2((c) => Array.isArray(c) ? c : [c], "preprocess") } : {}, ...u, valueSchema: l.create(i) }) : l.create({ ...i, ...u });
}
function Zm(e7, t) {
...
async function LF(e7, t = {}) {
  ...
  let o = qm({ plugins: e7.plugins, showDeprecated: true }).options, i = { ...lm, ...Object.fromEntries(o.filter((f) => f.default !== void 0).map(
    (f) => [f.name, f.default]
  )) }, l = Zm(n.plugins, n.parser), u = await Qm(l, n.parser);
...
async function _F(e7, t, r, n, o) {
  ...
  function v() {
    let { node: b } = e7;
    if (b === null || typeof b != "object" || u(e7)) return;
    for (let g7 of p(b)) Array.isArray(b[g7]) ? e7.each(v, g7) : e7.call(v, g7);
    let m = l(e7, r);
    if (m) {
...
async function PF(e7, t, r, n) {
  let o = await Co2({ ...r, ...t, parentParser: r.parser, originalText: e7 }, { passThrough: true }), { ast: i } = await La2(e7, o), l = await n(
    i,
    o
  );
  return Im(l);
...
function HF(e7, t) {
  let { originalText: r, [Symbol.for("comments")]: n, locStart: o, locEnd: i, [Symbol.for("printedComments")]: l } = t, { node: u } = e7, c = o(
    u
  ), p = i(u);
...
function sm(e7, t, r, n, o) {
  var i;
  let { node: l } = e7, { printer: u } = t, c;
  return (i = u.hasPrettierIgnore) != null && i.call(u, e7) ? c = $F(e7, t) : o.has(l) ? c = o.get(l) : c = u.print(e7, t, r, n), l === t.cursorNode && (c = Bm(c, (p) => [Tc, p, Tc])), u.printComment && (!u.willPrintOwnComments || !u.willPrintOwnComments(e7, t)) && (c = NA(e7, c, t)), c;
}
...
function zF(e7, t) {
  ...
  for (let c of SA(e7, { getVisitorKeys: i, filter: l })) u = c;
  return u;
}
function NF(e7, t) {
...
function Pc(e7, t, r, n, o = [], i) {
  let { locStart: l, locEnd: u } = r, c = l(e7), p = u(e7);
  if (!(t > p || t < c || i === "rangeEnd" && t === c || i === "rangeStart" && t === p)) {
    for (let d of Gc(e7, r)) {
      let h = Pc(d, t, r, n, [e7, ...o], i);
      if (h) return h;
    }
...
function KF(e7, t, r) {
  ...
  Mc.ok(o > n);
  let u = e7.slice(n, o).search(/\S/u), c = u === -1;
  if (!c) for (n += u; o > n && !/\S/u.test(e7[o - 1]); --o) ;
...
async function ZF(e7, t) {
  let { ast: r, text: n } = await La2(e7, t), { rangeStart: o, rangeEnd: i } = KF(n, t, r), l = n.slice(o, i), u = Math.min(o, n.lastIndexOf(`
...
function og(e7, t) {
  let { cursorOffset: r, rangeStart: n, rangeEnd: o, endOfLine: i } = dm(e7, t), l = e7.charAt(0) === rg;
  if (l && (e7 = e7.slice(1), r--, n--, o--), i === "auto" && (i = HR(e7)), e7.includes("\r")) {
    let u = a2((c) => xm(e7.slice(0, Math.max(c, 0)), `\r
`), "s");
    r -= u(r), n -= u(n), o -= u(o), e7 = $R(e7);
  }
  return { hasBOM: l, text: e7, options: dm(e7, { ...t, cursorOffset: r, rangeStart: n, rangeEnd: o, endOfLine: i }) };
}
...
function xk(e7, t, r) {
  let n = t === '"' ? "'" : '"', o = pl(false, e7, /\\(.)|(["'])/gsu, (i, l, u) => l === n ? l : u === t ? "\\" + u : u || (r && /^[^\n\r"'0-7\\bfnrt-vx\u2028\u2029]$/u.test(l) ? l : "\\" + l));
  return t + o + t;
}
function Ek(e7, t, r) {
  return Zc(e7, r(t));
...
var pg = F2(() => {
  ...
  FR = ER(() => {
    ...
    "use strict";
    Object.defineProperty(e7, "__esModule", { value: true }), e7.codeFrameColumns = v, e7.default = b;
    ...
    function o(m, g7) {
      ...
      for (var x in m) if (x !== "default" && {}.hasOwnProperty.call(m, x)) {
        var C = D7 ? Object.getOwnPropertyDescriptor(m, x) : null;
        C && (C.get || C.set) ? Object.defineProperty(w5, x, C) : w5[x] = m[x];
      }
      return w5.default = m, y && y.set(m, w5), w5;
    }
    a2(o, "vo");
    var i = r.default, l = a2((m, g7) => (y) => m(g7(y)), "Rn"), u;
    function c(m) {
      if (m) {
        var g7;
    ...
    var h = /\r\n|[\n\r\u2028\u2029]/;
    function f(m, g7, y) {
      let w5 = Object.assign({ column: 0, line: -1 }, m.start), D7 = Object.assign({}, w5, m.end), { linesAbove: x = 2, linesBelow: C = 3 } = y || {}, E = w5.line, S = w5.column, R = D7.line, A = D7.column, k4 = Math.max(E - (x + 1), 0), B6 = Math.min(g7.length, R + C);
      E === -1 && (k4 = 0), R === -1 && (B6 = g7.length);
      let $6 = R - E, M6 = {};
      ...
      else S === A ? S ? M6[E] = [S, 0] : M6[E] = true : M6[E] = [S, A - S];
      return { start: k4, end: B6, markerLines: M6 };
    }
    a2(f, "No");
    function v(m, g7, y = {}) {
      let w5 = (y.highlightCode || y.forceColor) && (0, t.shouldHighlight)(y), D7 = c(y.forceColor), x = d(D7), C = a2((M6, W) => w5 ? M6(W) : W, "i"), E = m.split(h), { start: S, end: R, markerLines: A } = f(g7, E, y), k4 = g7.start && typeof g7.start.column == "number", B6 = String(
        R
      ).length, $6 = (w5 ? (0, t.default)(m, y) : m).split(h, R).slice(S, R).map((M6, W) => {
        let T = S + 1 + W, L6 = ` ${` ${T}`.slice(-B6)} |`, P6 = A[T], U6 = !A[T + 1];
        if (P6) {
          let N = "";
          if (Array.isArray(P6)) {
            let G = M6.slice(0, Math.max(P6[0] - 1, 0)).replace(/[^\t]/g, " "), z6 = P6[1] || 1;
            N = [`
 `, C(x.gutter, L6.replace(/\d/g, " ")), " ", G, C(x.marker, "^").repeat(z6)].join(""), U6 && y.message && (N += " " + C(x.message, y.message));
          }
          return [C(x.marker, ">"), C(x.gutter, L6), M6.length > 0 ? ` ${M6}` : "", N].join("");
        } else return ` ${C(x.gutter, L6)}${M6.length > 0 ? ` ${M6}` : ""}`;
      }).join(`
`);
...
${$6}`), w5 ? D7.reset($6) : $6;
    ...
    function b(m, g7, y, w5 = {}) {
      if (!p) {
        ...
        {
          let x = new Error(D7);
          x.name = "DeprecationWarning", console.warn(new Error(D7));
        }
      }
      return y = Math.max(y, 0), v(m, { start: { column: y, line: g7 } }, w5);
    }
    a2(b, "To");
  }), bm = {};
  ...
  _t2.prototype = { diff: a2(function(e7, t) {
    ...
    a2(l, "s"), e7 = this.castInput(e7), t = this.castInput(t), e7 = this.removeEmpty(this.tokenize(e7)), t = this.removeEmpty(this.tokenize(t));
    var u = t.length, c = e7.length, p = 1, d = u + c;
    n.maxEditLength && (d = Math.min(d, n.maxEditLength));
    var h = (r = n.timeout) !== null && r !== void 0 ? r : 1 / 0, f = Date.now() + h, v = [{ oldPos: -1, lastComponent: void 0 }], b = this.extractCommon(v[0], t, e7, 0);
    if (v[0].oldPos + 1 >= c && b + 1 >= u) return l([{ value: this.join(t), count: t.length }]);
    var m = -1 / 0, g7 = 1 / 0;
    function y() {
      for (var D7 = Math.max(m, -p); D7 <= Math.min(g7, p); D7 += 2) {
        var x = void 0, C = v[D7 - 1], E = v[D7 + 1];
        C && (v[D7 - 1] = void 0);
        var S = false;
        if (E) {
          var R = E.oldPos - D7;
        ...
        if (!A || S && C.oldPos + 1 < E.oldPos ? x = i.addToPath(E, true, void 0, 0) : x = i.addToPath(C, void 0, true, 1), b = i.extractCommon(
          ...
          e7,
          D7
        ), x.oldPos + 1 >= c && b + 1 >= u) return l(IR(i, x.lastComponent, t, e7, i.useLongestToken));
        v[D7] = x, x.oldPos + 1 >= c && (g7 = Math.min(g7, D7 - 1)), b + 1 >= u && (m = Math.max(m, D7 + 1));
      }
      p++;
    }
    ...
    for (var o = t.length, i = r.length, l = e7.oldPos, u = l - n, c = 0; u + 1 < o && l + 1 < i && this.equals(t[u + 1], r[l + 1]); ) u++, l++, c++;
    return c && (e7.lastComponent = { count: c, previousComponent: e7.lastComponent }), e7.oldPos = l, u;
...
in order for it to be formatted.`,
  ...
  ZA = KA, oo2 = { key: a2((e7) => /^[$_a-zA-Z][$_a-zA-Z0-9]*$/.test(e7) ? e7 : JSON.stringify(e7), "key"), value(e7) {
    ...
    return n && i.push(Z2(e7, t, n, r.descriptor)), o && i.push([Z2(e7, t, o.title, r.descriptor)].concat(o.values.map((l) => Um(l, r.loggerPrintWidth))).join(`
`)), Gm(i, r.loggerPrintWidth);
  ...
  Xm = a2((e7, t, { descriptor: r, logger: n, schemas: o }) => {
    let i = [`Ignored unknown option ${J22.default.yellow(r.pair({ key: e7, value: t }))}.`], l = Object.keys(o).sort().find((u) => eF(e7, u) < 3);
    l && i.push(`Did you mean ${J22.default.blue(r.key(l))}?`), n.warn(i.join(" "));
  ...
  gF = (go2 = class extends lr2 {
    ...
    constructor(t, r) {
      let { logger: n = console, loggerPrintWidth: o = 80, descriptor: i = bF, unknown: l = yF, invalid: u = DF, deprecated: c = xF, missing: p = a2(
        () => false,
        "D"
      ...
      }, this._unknownHandler = l, this._invalidHandler = hF(u), this._deprecatedHandler = c, this._identifyMissing = (v, b) => !(v in b) || p(v, b), this._identifyRequired = d, this._preprocess = h, this._postprocess = f, this.cleanHistory();
    }
    cleanHistory() {
    ...
    _applyNormalization(t, r) {
      ...
      for (let l of o) {
        ...
        let p = a2(({ from: f, to: v }) => {
          ...
          let b = nm(u.deprecated(f, this._utils), c, true);
...
function Qe2(e7, t, r) {
  ...
  var l = Je2(e7) ? ee2(e7) : window, u = l.visualViewport, c = !Na2() && r, p = (n.left + (c && u ? u.offsetLeft : 0)) / o, d = (n.top + (c && u ? u.offsetTop : 0)) / i, h = n.width / o, f = n.height / i;
  return {
    width: h,
    height: f,
    top: d,
...
function tB(e7) {
  var t, r = e7.state, n = e7.name, o = e7.options, i = r.elements.arrow, l = r.modifiersData.popperOffsets, u = ge2(r.placement), c = Zr2(u), p = [
    oe2,
    se2
  ].indexOf(u) >= 0, d = p ? "height" : "width";
  if (!(!i || !l)) {
    var h = eB(o.padding, r), f = Kr2(i), v = c === "y" ? ne2 : oe2, b = c === "y" ? ce2 : se2, m = r.rects.reference[d] + r.rects.reference[c] - l[c] - r.rects.popper[d], g7 = l[c] - r.rects.reference[c], y = pt(i), w5 = y ? c === "y" ? y.clientHeight || 0 : y.clientWidth || 0 : 0, D7 = m / 2 - g7 / 2, x = h[v], C = w5 - f[d] - h[b], E = w5 / 2 - f[d] / 2 + D7, S = Jr2(x, E, C), R = c;
...
function d3(e7) {
  var t, r = e7.popper, n = e7.popperRect, o = e7.placement, i = e7.variation, l = e7.offsets, u = e7.position, c = e7.gpuAcceleration, p = e7.adaptive, d = e7.roundOffsets, h = e7.isFixed, f = l.x, v = f === void 0 ? 0 : f, b = l.y, m = b === void 0 ? 0 : b, g7 = typeof d == "function" ? d({
    x: v,
    y: m
  }) : {
    x: v,
  ...
  v = g7.x, m = g7.y;
  var y = l.hasOwnProperty("x"), w5 = l.hasOwnProperty("y"), D7 = oe2, x = ne2, C = window;
  if (p) {
  ...
  if (v = $6.x, m = $6.y, c) {
    var M6;
    return Object.assign({}, B6, (M6 = {}, M6[x] = w5 ? "0" : "", M6[D7] = y ? "0" : "", M6.transform = (C.devicePixelRatio || 1) <= 1 ? "translate(" + v + "px, " + m + "px)" : "translate3d(" + v + "px, " + m + "px, 0)", M6));
  }
  return Object.assign({}, B6, (t = {}, t[x] = w5 ? m + "px" : "", t[D7] = y ? v + "px" : "", t.transform = "", t));
}
function aB(e7) {
  var t = e7.state, r = e7.options, n = r.gpuAcceleration, o = n === void 0 ? true : n, i = r.adaptive, l = i === void 0 ? true : i, u = r.roundOffsets, c = u === void 0 ? true : u, p = {
...
function iB(e7) {
  var t = e7.state, r = e7.instance, n = e7.options, o = n.scroll, i = o === void 0 ? true : o, l = n.resize, u = l === void 0 ? true : l, c = ee2(t.elements.popper), p = [].concat(t.scrollParents.reference, t.scrollParents.popper);
...
function c1(e7, t) {
  var r = ee2(e7), n = xe(e7), o = r.visualViewport, i = n.clientWidth, l = n.clientHeight, u = 0, c = 0;
  if (o) {
...
function p1(e7) {
  var t, r = xe(e7), n = Qr2(e7), o = (t = e7.ownerDocument) == null ? void 0 : t.body, i = ct2(r.scrollWidth, r.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0), l = ct2(r.scrollHeight, r.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0), u = -n.scrollLeft + en2(
    e7
  ), c = -n.scrollTop;
...
function hr2(e7, t) {
  var r;
  t === void 0 && (t = []);
  var n = Ul(e7), o = n === ((r = e7.ownerDocument) == null ? void 0 : r.body), i = ee2(n), l = o ? [i].concat(i.visualViewport || [], tn2(n) ? n : []) : n, u = t.concat(l);
  return o ? u : (
...
function h1(e7, t, r, n) {
  var o = t === "clippingParents" ? cB(e7) : [].concat(t), i = [].concat(o, [r]), l = i[0], u = i.reduce(function(c, p) {
    var d = x3(e7, p, n);
...
function Ga2(e7) {
  var t = e7.reference, r = e7.element, n = e7.placement, o = n ? ge2(n) : null, i = n ? et2(n) : null, l = t.x + t.width / 2 - r.width / 2, u = t.y + t.height / 2 - r.height / 2, c;
  switch (o) {
    case ne2:
      c = {
        x: l,
...
function dt(e7, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, o = n === void 0 ? e7.placement : n, i = r.strategy, l = i === void 0 ? e7.strategy : i, u = r.boundary, c = u === void 0 ? r3 : u, p = r.rootBoundary, d = p === void 0 ? Hl : p, h = r.elementContext, f = h === void 0 ? Mo : h, v = r.altBoundary, b = v === void 0 ? false : v, m = r.padding, g7 = m === void 0 ? 0 : m, y = Wa2(typeof g7 != "number" ? g7 : Ua2(g7, cr2)), w5 = f === Mo ? n3 : Mo, D7 = e7.rects.popper, x = e7.elements[b ? w5 : f], C = h1(Je2(x) ? x : x.contextElement || xe(e7.elements.popper), c, d, l), E = Qe2(e7.elements.reference), S = Ga2(
    {
      reference: E,
      element: D7,
      strategy: "absolute",
  ...
  ), R = jo(Object.assign({}, D7, S)), A = f === Mo ? R : E, k4 = {
...
function dB(e7) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var o = r.mainAxis, i = o === void 0 ? true : o, l = r.altAxis, u = l === void 0 ? true : l, c = r.fallbackPlacements, p = r.padding, d = r.boundary, h = r.rootBoundary, f = r.altBoundary, v = r.flipVariations, b = v === void 0 ? true : v, m = r.allowedAutoPlacements, g7 = t.options.placement, y = ge2(g7), w5 = y === g7, D7 = c || (w5 || !b ? [No(g7)] : pB(g7)), x = [g7].concat(D7).reduce(function(ve2, de2) {
      ...
      var B6 = x[k4], $6 = ge2(B6), M6 = et2(B6) === Vt2, W = [ne2, ce2].indexOf($6) >= 0, T = W ? "width" : "height", L6 = dt(t, {
        placement: B6,
        boundary: d,
        rootBoundary: h,
        altBoundary: f,
      ...
      C[T] > E[T] && (P6 = No(P6));
      var U6 = No(P6), N = [];
      if (i && N.push(L6[$6] <= 0), u && N.push(L6[P6] <= 0, L6[U6] <= 0), N.every(function(ve2) {
        return ve2;
      })) {
        A = B6, R = false;
        break;
...
function fB(e7) {
  var t = e7.state, r = e7.name, n = t.rects.reference, o = t.rects.popper, i = t.modifiersData.preventOverflow, l = dt(t, {
...
function mB(e7) {
  var t = e7.state, r = e7.options, n = e7.name, o = r.offset, i = o === void 0 ? [0, 0] : o, l = $l.reduce(function(d, h) {
...
function vB(e7) {
  var t = e7.state, r = e7.options, n = e7.name, o = r.mainAxis, i = o === void 0 ? true : o, l = r.altAxis, u = l === void 0 ? false : l, c = r.boundary, p = r.rootBoundary, d = r.altBoundary, h = r.padding, f = r.tether, v = f === void 0 ? true : f, b = r.tetherOffset, m = b === void 0 ? 0 : b, g7 = dt(t, {
    boundary: c,
    rootBoundary: p,
    padding: h,
    altBoundary: d
  }), y = ge2(t.placement), w5 = et2(t.placement), D7 = !w5, x = Zr2(y), C = v1(x), E = t.modifiersData.popperOffsets, S = t.rects.reference, R = t.rects.popper, A = typeof m == "function" ? m(Object.assign({}, t.rects, {
    placement: t.placement
  ...
  if (E) {
    if (i) {
      var M6, W = x === "y" ? ne2 : oe2, T = x === "y" ? ce2 : se2, L6 = x === "y" ? "height" : "width", P6 = E[x], U6 = P6 + g7[W], N = P6 - g7[T], G = v ? -R[L6] / 2 : 0, z6 = w5 === Vt2 ? S[L6] : R[L6], K3 = w5 === Vt2 ? -R[L6] : -S[L6], Te2 = t.elements.arrow, ve2 = v && Te2 ? Kr2(Te2) : {
        width: 0,
        height: 0
        ...
        S[L6],
        ve2[L6]
      ), Xo = D7 ? S[L6] / 2 - G - Ie2 - Ce2 - k4.mainAxis : z6 - Ie2 - Ce2 - k4.mainAxis, Yo = D7 ? -S[L6] / 2 + G + Ie2 + Le2 + k4.mainAxis : K3 + Ie2 + Le2 + k4.mainAxis, ns = t.elements.arrow && pt(t.elements.arrow), R4 = ns ? x === "y" ? ns.clientTop || 0 : ns.clientLeft || 0 : 0, G1 = (M6 = B6 == null ? void 0 : B6[x]) != null ? M6 : 0, A4 = P6 + Xo - G1 - R4, F4 = P6 + Yo - G1, X1 = Jr2(v ? Yr2(U6, A4) : U6, P6, v ? ct2(N, F4) : N);
      E[x] = X1, $6[x] = X1 - P6;
    }
    if (u) {
      var Y1, k42 = x === "x" ? ne2 : oe2, T4 = x === "x" ? ce2 : se2, vr2 = E[C], Ja2 = C === "y" ? "height" : "width", K1 = vr2 + g7[k42], Z1 = vr2 - g7[T4], os = [ne2, oe2].indexOf(y) !== -1, J1 = (Y1 = B6 == null ? void 0 : B6[C]) != null ? Y1 : 0, Q1 = os ? K1 : vr2 - S[Ja2] - R[Ja2] - J1 + k4.altAxis, ep = os ? vr2 + S[Ja2] + R[Ja2] - J1 - k4.altAxis : Z1, tp = v && os ? u3(Q1, vr2, ep) : Jr2(v ? Q1 : K1, vr2, v ? ep : Z1);
      E[C] = tp, $6[C] = tp - vr2;
    }
    t.modifiersData[n] = $6;
  }
...
function D1(e7, t, r) {
  r === void 0 && (r = false);
  var n = pe2(t), o = pe2(t) && wB(t), i = xe(t), l = Qe2(e7, o, r), u = {
    scrollLeft: 0,
    scrollTop: 0
  }, c = {
    x: 0,
  ...
  return a2(function(u, c, p) {
    ...
    var d = {
      ...
      setOptions: a2(function(y) {
        ...
        return d.orderedModifiers = D7.filter(function(x) {
          return x.enabled;
        }), b(), v.update();
      }, "setOptions"),
    ...
    function b() {
      d.orderedModifiers.forEach(function(g7) {
        var y = g7.name, w5 = g7.options, D7 = w5 === void 0 ? {} : w5, x = g7.effect;
...
function i4(e7, t) {
  ...
  }), c = X2.useState(null), p = c[0], d = c[1], h = X2.useState(null), f = h[0], v = h[1], b = AB({
  ...
  var w5 = R1(i.followCursor ? r4 : p, f, u), D7 = w5.styles, x = w5.attributes, C = sn2(w5, FB), E = C.update, S = o4({
    visible: m,
    triggerRef: p,
    tooltipRef: f,
    finalConfig: i
  ...
  X2.useEffect(function() {
    if (S().finalConfig.closeOnOutsideClick) {
      var T = a2(function(P6) {
        var U6, N = S(), G = N.tooltipRef, z6 = N.triggerRef, K3 = (P6.composedPath == null || (U6 = P6.composedPath()) == null ? void 0 : U6[0]) || P6.target;
  ...
  var $6 = C == null || (r = C.state) == null || (n = r.modifiersData) == null || (o = n.hide) == null ? void 0 : o.isReferenceHidden;
  X2.useEffect(function() {
    ...
    function T(L6) {
      ...
      r4.getBoundingClientRect = a4(P6, U6), E == null ? void 0 : E();
    }
  ...
  var M6 = a2(function(L6) {
    ...
    return L6 === void 0 && (L6 = {}), H2({}, L6, x.arrow, {
...
var c4 = F2(() => {
  ...
  u4 = we2(Qo(), 1), tt2 = (0, u4.default)(1e3)(
    ...
    ({
      ...
      withArrows: l,
      ...u
    }, c) => import_react8.default.createElement(TB, { "data-testid": "tooltip", hasChrome: t, ref: c, ...u, color: i }, t && l && import_react8.default.createElement(kB, { placement: e7, ...n, color: i }), r)
  );
...
`, d4 = a2(({
    ...
    return import_react9.default.createElement(import_react9.default.Fragment, null, import_react9.default.createElement(C, { trigger: t, ref: A, ...x }, d), k4 && import_react_dom.default.createPortal($6, Xl.body));
...
function Zo(e7, t, r, n) {
  if (n === void 0 && (n = z4), t === 0)
    return n(r, r, r);
  var o = (e7 % 360 + 360) % 360 / 60, i = (1 - Math.abs(2 * r - 1)) * t, l = i * (1 - Math.abs(o % 2 - 1)), u = 0, c = 0, p = 0;
...
function ps(e7) {
  ...
  if (f) {
    var v = parseInt("" + f[1], 10), b = parseInt("" + f[2], 10) / 100, m = parseInt("" + f[3], 10) / 100, g7 = "rgb(" + Zo(v, b, m) + ")", y = ls.exec(g7);
    if (!y)
      throw new ht(4, t, g7);
    return {
      red: parseInt("" + y[1], 10),
...
a2(ps, "parseToRgb");
function X4(e7) {
  var t = e7.red / 255, r = e7.green / 255, n = e7.blue / 255, o = Math.max(t, r, n), i = Math.min(t, r, n), l = (o + i) / 2;
  if (o === i)
    return e7.alpha !== void 0 ? {
      hue: 0,
      saturation: 0,
...
function xg(e7, t = []) {
  ...
  function n(i, l) {
    ...
    function p(h) {
      let { scope: f, children: v, ...b } = h, m = (f == null ? void 0 : f[e7][c]) || u, g7 = (0, import_react20.useMemo)(
        () => b,
        Object.values(b)
      );
    ...
    a2(p, "Provider");
    function d(h, f) {
      let v = (f == null ? void 0 : f[e7][c]) || u, b = (0, import_react20.useContext)(v);
      if (b) return b;
      if (l !== void 0) return l;
      throw new Error(`\`${h}\` must be used within \`${i}\``);
    }
...
function Cg({ prop: e7, defaultProp: t, onChange: r = a2(() => {
  ...
  let [n, o] = Kk({
    defaultProp: t,
    onChange: r
  }), i = e7 !== void 0, l = i ? e7 : n, u = it2(r), c = (0, import_react22.useCallback)((p) => {
    if (i) {
      let h = typeof p == "function" ? p(e7) : p;
      h !== e7 && u(h);
    } else o(p);
  }, [
    i,
...
var Lg = (0, import_react24.forwardRef)((e7, t) => {
  ...
  let {
    ...
    onDismiss: c,
    ...p
  } = e7, d = (0, import_react24.useContext)(fT), [h, f] = (0, import_react24.useState)(null), v = (r = h == null ? void 0 : h.ownerDocument) !== null && r !== void 0 ? r : globalThis == null ? void 0 : globalThis.document, [, b] = (0, import_react24.useState)({}), m = St2(
    t,
    (R) => f(R)
  ), g7 = Array.from(d.layers), [y] = [
    ...d.layersWithOutsidePointerEventsDisabled
  ].slice(-1), w5 = g7.indexOf(y), D7 = h ? g7.indexOf(h) : -1, x = d.layersWithOutsidePointerEventsDisabled.size > 0, C = D7 >= w5, E = hT((R) => {
    let A = R.target, k4 = [
      ...d.branches
    ].some(
      (B6) => B6.contains(A)
  ...
  return Ag((R) => {
    ...
    onFocusCapture: Et2(e7.onFocusCapture, S.onFocusCapture),
    onBlurCapture: Et2(e7.onBlurCapture, S.onBlurCapture),
    onPointerDownCapture: Et2(e7.onPointerDownCapture, E.onPointerDownCapture)
  }));
});
...
var zg = (0, import_react28.forwardRef)((e7, t) => {
  let { loop: r = false, trapped: n = false, onMountAutoFocus: o, onUnmountAutoFocus: i, ...l } = e7, [u, c] = (0, import_react28.useState)(null), p = it2(o), d = it2(i), h = (0, import_react28.useRef)(
    null
  ), f = St2(
    t,
    (m) => c(m)
  ...
  (0, import_react28.useEffect)(() => {
    if (n) {
      let m = function(D7) {
        ...
        if (v.paused || !u) return;
        let x = D7.relatedTarget;
        x !== null && (u.contains(x) || sr2(h.current, {
          select: true
        }));
      }, y = function(D7) {
        if (document.activeElement === document.body)
          for (let C of D7) C.removedNodes.length > 0 && sr2(u);
      };
  ...
  let b = (0, import_react28.useCallback)((m) => {
    ...
    if (g7 && y) {
      let w5 = m.currentTarget, [D7, x] = DT(w5);
      D7 && x ? !m.shiftKey && y === x ? (m.preventDefault(), r && sr2(D7, {
        select: true
      })) : m.shiftKey && y === D7 && (m.preventDefault(), r && sr2(x, {
        select: true
...
function HT(e7) {
  let [t, r] = (0, import_react30.useState)(), n = (0, import_react30.useRef)({}), o = (0, import_react30.useRef)(e7), i = (0, import_react30.useRef)("none"), l = e7 ? "mounted" : "unmounted", [u, c] = PT(l, {
    mounted: {
      UNMOUNT: "unmounted",
      ANIMATION_OUT: "unmountSuspended"
    },
...
function p0(e7, t) {
  ...
  return Gg.useLayoutEffect(function() {
    var n = Ug.get(r);
    if (n) {
      var o = new Set(n), i = new Set(e7), l = r.current;
...
var Ha2 = Se2.forwardRef(function(e7, t) {
  ...
  return Se2.createElement(
    Se2.Fragment,
    null,
    d && Se2.createElement(D7, { sideCar: El, removeScrollBar: p, shards: h, noIsolation: v, inert: b, setCallbacks: i, allowPinchZoom: !!m, lockRef: r }),
...
var XT = a2(function(e7, t, r, n) {
  var o = e7.left, i = e7.top, l = e7.right, u = e7.gap;
...
var rv = a2(function(e7, t, r, n, o) {
  var i = eL(e7, window.getComputedStyle(t).direction), l = i * n, u = r.target, c = t.contains(u), p = false, d = l > 0, h = 0, f = 0;
  do {
    var v = tv(e7, u), b = v[0], m = v[1], g7 = v[2], y = m - g7 - i * b;
    (b || y) && ev(e7, u) && (h += y, f += b), u = u.parentNode;
  } while (
    // portaled content
...
function av(e7) {
  ...
  var u = J2.useCallback(function(m, g7) {
    if ("touches" in m && m.touches.length === 2)
      return !l.current.allowPinchZoom;
    var y = Rl(m), w5 = r.current, D7 = "deltaX" in m ? m.deltaX : w5[0] - y[0], x = "deltaY" in m ? m.deltaY : w5[1] - y[1], C, E = m.target, S = Math.abs(D7) > Math.abs(x) ? "h" : "v";
    ...
    if (R ? C = S : (C = S === "v" ? "h" : "v", R = D0(S, E)), !R)
      return false;
    if (!n.current && "changedTouches" in m && (D7 || x) && (n.current = C), !C)
      return true;
    var A = n.current || C;
    return rv(A, g7, m, A === "h" ? D7 : x, true);
  }, []), c = J2.useCallback(function(m) {
    var g7 = m;
    if (!(!Ao2.length || Ao2[Ao2.length - 1] !== i)) {
      var y = "deltaY" in g7 ? nv(g7) : Rl(g7), w5 = t.current.filter(function(C) {
        return C.name === g7.type && C.target === g7.target && tL(C.delta, y);
      })[0];
      if (w5 && w5.should) {
      ...
      if (!w5) {
        var D7 = (l.current.shards || []).map(ov).filter(Boolean).filter(function(C) {
          return C.contains(g7.target);
        }), x = D7.length > 0 ? u(g7, D7[0]) : !l.current.noIsolation;
    ...
    p(m.type, nv(m), m.target, u(m, e7.lockRef.current));
  }, []), f = J2.useCallback(function(m) {
    p(m.type, Rl(m), m.target, u(m, e7.lockRef.current));
  }, []);
  J2.useEffect(function() {
  ...
  var v = e7.removeScrollBar, b = e7.inert;
  ...
  var d = a2(function(h) {
    !h || c.has(h) || Array.prototype.forEach.call(h.children, function(f) {
      if (u.has(f))
        ...
        var v = f.getAttribute(n), b = v !== null && v !== "false", m = (Fo.get(f) || 0) + 1, g7 = (i.get(f) || 0) + 1;
        Fo.set(f, m), i.set(f, g7), l.push(f), m === 1 && b && Fl.set(f, true), g7 === 1 && f.setAttribute(r, "true"), b || f.setAttribute(n, "true");
      }
    });
  }, "deep");
...
var [gL, lt2] = fv(dv);
var hv = a2((e7) => {
  let { __scopeDialog: t, children: r, open: n, defaultOpen: o, onOpenChange: i, modal: l = true } = e7, u = (0, import_react18.useRef)(null), c = (0, import_react18.useRef)(null), [p = false, d] = Cg(
    {
      prop: n,
      defaultProp: o,
      onChange: i
...
var DL = (0, import_react18.forwardRef)((e7, t) => {
  ...
  return (0, import_react18.createElement)(Dv, H2({}, e7, {
    ...
    onCloseAutoFocus: a2((i) => {
      var l;
      if ((l = e7.onCloseAutoFocus) === null || l === void 0 || l.call(e7, i), !i.defaultPrevented) {
        var u;
    ...
    onInteractOutside: a2((i) => {
      var l, u;
      (l = e7.onInteractOutside) === null || l === void 0 || l.call(e7, i), i.defaultPrevented || (n.current = true, i.detail.originalEvent.type === "pointerdown" && (o.current = true));
      let c = i.target;
...
var Dv = (0, import_react18.forwardRef)((e7, t) => {
  let { __scopeDialog: r, trapFocus: n, onOpenAutoFocus: o, onCloseAutoFocus: i, ...l } = e7, u = lt2(To2, r), c = (0, import_react18.useRef)(null), p = St2(t, c);
...
var Lo = (0, import_react36.forwardRef)(
  ({
    ...
    let h = n, f = r, [v, b] = (0, import_react36.useState)(false), m = a2((g7) => {
...
var BL = Tr("button", {
...
})(({ theme: e7, variant: t, size: r, disabled: n, active: o, animating: i, animation: l = "none", padding: u }) => ({
  border: 0,
  ...
  "> svg": {
    animation: i && l !== "none" ? `${e7.animation[l]} 1000ms ease-out` : ""
  }
}));
...
function Bl(e7) {
  ...
  var p = (0, import_react40.useRef)({
    width: void 0,
    height: void 0
  }), d = oI((0, import_react40.useCallback)(function(h) {
    return (!o.current || o.current.box !== e7.box || o.current.round !== n) && (o.current = {
      box: e7.box,
      round: n,
      instance: new ResizeObserver(function(f) {
        var v = f[0], b = e7.box === "border-box" ? "borderBoxSize" : e7.box === "device-pixel-content-box" ? "devicePixelContentBoxSize" : "contentBoxSize", m = Bv(v, b, "inlineSize"), g7 = Bv(v, b, "blockSize"), y = m ? n(m) : void 0, w5 = g7 ? n(g7) : void 0;
        if (p.current.width !== y || p.current.height !== w5) {
          var D7 = {
            width: y,
            height: w5
          };
          p.current.width = y, p.current.height = w5, r.current ? r.current(D7) : c.current || u(D7);
        }
      })
...
${t}`);
  ...
  return import_react42.default.createElement(import_react42.Fragment, null, import_react42.default.createElement("span", null, n), ": ", import_react42.default.createElement(
    ...
    (u, c) => (u == null ? void 0 : u.name) ? import_react42.default.createElement(import_react42.Fragment, { key: c }, "  ", "at ", import_react42.default.createElement(mI, null, u.name), " (", import_react42.default.createElement(Hv, null, u.location), ")", import_react42.default.createElement("br", null)) : import_react42.default.createElement(
      import_react42.Fragment,
      { key: c },
      "  ",
      "at ",
      import_react42.default.createElement(Hv, null, u == null ? void 0 : u.location),
...
function kI(e7, t, r, n) {
  ...
  var o = e7.paddingSize, i = e7.borderSize, l = e7.sizingStyle, u = l.boxSizing;
...
var $I = a2(function(t, r) {
  var n = t.cacheMeasurements, o = t.maxRows, i = t.minRows, l = t.onChange, u = l === void 0 ? Xv : l, c = t.onHeightChange, p = c === void 0 ? Xv : c, d = sn2(t, HI), h = d.value !== void 0, f = st2.useRef(null), v = qv(f, r), b = st2.useRef(0), m = st2.useRef(), g7 = a2(
    function() {
      var D7 = f.current, x = n && m.current ? m.current : MI(D7);
      if (x) {
        m.current = x;
        var C = kI(x, D7.value || D7.placeholder || "x", i, o), E = C[0], S = C[1];
        b.current !== E && (b.current = E, D7.style.setProperty("height", E + "px", "important"), p(E, {
          rowHeight: S
        }));
      }
    },
...
var oM = a2(({
  ...
  return import_react51.default.createElement(rM, { ...h, ...f, ...v }, import_react51.default.createElement(import_react51.default.Fragment, null, p && import_react51.default.createElement(tM, { ...f }, p), t || r ? import_react51.default.createElement(QB, { isIndented: !!(!p && l) }, t && import_react51.default.createElement(
    ZB,
    { ...f, loading: e7 },
    t
...
var sM = a2(({ id: e7, onClick: t, ...r }) => {
  let { active: n, disabled: o, title: i, href: l } = r, u = (0, import_react50.useCallback)(
    (c) => t == null ? void 0 : t(c, { id: e7, active: n, disabled: o, title: i, href: l }),
    [t, e7, n, o, i, l]
  );
  return import_react50.default.createElement(L1, { id: `list-item-${e7}`, ...r, ...t && { onClick: u } });
}, "Item");
...
function y4(e7) {
  let t = (0, import_react57.useRef)(), r = (0, import_react57.useRef)(), n = (0, import_react57.useRef)(/* @__PURE__ */ new Map()), { width: o = 1 } = Bl({
    // @ts-expect-error (non strict)
    ref: t
  }), [i, l] = (0, import_react57.useState)(e7), [u, c] = (0, import_react57.useState)([]), p = (0, import_react57.useRef)(e7), d = (0, import_react57.useCallback)(
    ({
      menuName: f,
      actions: v
    }) => {
      let b = u.some(({ active: y }) => y), [m, g7] = (0, import_react57.useState)(false);
      return import_react57.default.createElement(import_react57.default.Fragment, null, import_react57.default.createElement(
        k1,
        {
          ...
          tooltip: import_react57.default.createElement(
            B1,
            {
              links: u.map(({ title: y, id: w5, color: D7, active: x }) => ({
                id: w5,
                title: y,
                color: D7,
                active: x,
      ...
      ), u.map(({ title: y, id: w5, color: D7 }, x) => {
        let C = `index-${x}`;
    ...
    if (!t.current || !r.current)
      return;
    let { x: f, width: v } = t.current.getBoundingClientRect(), { width: b } = r.current.getBoundingClientRect(), m = u.length ? f + v - b : f + v, g7 = [], y = 0, w5 = e7.filter((D7) => {
      let { id: x } = D7, C = n.current.get(x), { width: E = 0 } = (C == null ? void 0 : C.getBoundingClientRect()) || {}, S = f + y + E > m;
      return (!S || !C) && g7.push(D7), y += E, S;
    });
    (g7.length !== i.length || p.current !== e7) && (l(g7), c(w5), p.current = e7);
  }, [u.length, e7, i]);
...
var q1 = (0, import_react52.memo)(
  ({
    ...
    let h = (0, import_react52.useMemo)(
      ...
      [e7, t]
    ), { visibleList: f, tabBarRef: v, tabRefs: b, AddonTab: m } = y4(h), g7 = p ?? import_react52.default.createElement($1, { title: "Nothing found" });
    return !d && h.length === 0 ? g7 : (
      // @ts-expect-error (non strict)
      import_react52.default.createElement(PM, { absolute: n, bordered: o, id: u }, import_react52.default.createElement(Kl, {
        scrollable: false,
        border: true,
        backgroundColor: l
      ...
      }), import_react52.default.createElement(m, { menuName: c, actions: r })), i), import_react52.default.createElement(HM, { id: "panel-tab-content", bordered: o, absolute: n }, h.length ? h.map(({ id: y, active: w5, render: D7 }) => import_react52.default.createElement(D7, { key: y, active: w5 }, null)) : g7))
    );
  }
);
q1.displayName = "Tabs";
...
var d_ = a2(({ progress: e7, error: t, size: r, ...n }) => {
  ...
  if (e7) {
    let { value: o, modules: i } = e7, { message: l } = e7;
    return i && (l += ` ${i.complete} / ${i.total} modules`), import_react63.default.createElement(
      ...
      import_react63.default.createElement(E4, null, l, o < 1 && import_react63.default.createElement(p_, { key: l }))
    );
  }
...
//# sourceMappingURL=chunk-X6TRMFRX.js.map
