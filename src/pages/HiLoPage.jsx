    ...
    <div className="nuts-page">
      ...
      <main className="nuts-page__main nuts-page__main--game">
        <div className="nuts-hilo">
          <div className="nuts-hilo__panel nuts-hilo__controls">
            ...
            <div className="nuts-hilo__bet">
              <button type="button" className="nuts-hilo__bet-btn">MIN</button>
              <button type="button" className="nuts-hilo__bet-btn">−</button>
              <div className="nuts-hilo__bet-input">
                <span>$0.28</span>
                <span className="nuts-hilo__bet-sol">0.00327680 SOL</span>
              </div>
              <button type="button" className="nuts-hilo__bet-btn">+</button>
              <button type="button" className="nuts-hilo__bet-btn">MAX</button>
            </div>
          </div>
          <div className="nuts-hilo__panel nuts-hilo__game">
            <div className="nuts-hilo__tabs">
              <button type="button" className="nuts-hilo__tab nuts-hilo__tab--active">PAYOUT</button>
              <button type="button" className="nuts-hilo__tab">CHANCE</button>
            </div>
            ...
            <div className="nuts-hilo__previous">
              ...
              <Button variant="primary" className="nuts-hilo__start">start</Button>
        ...
        <div className="nuts-hilo__live">
          <div className="nuts-hilo__tabs">
            <button type="button" className="nuts-hilo__tab nuts-hilo__tab--active">LIVE GAMES</button>
            <button type="button" className="nuts-hilo__tab">MY GAMES</button>
          </div>
          <ul className="nuts-hilo__list">
            <li><span className="nuts-hilo__list-icon">◆</span> Mines · DOP3Y · 10:08:13 AM · x4368252.00 · -$0.00</li>
            <li><span className="nuts-hilo__list-icon">◆</span> Dice · Lugarge · 10:08:12 AM · x2.48 · -$0.00</li>
          </ul>
        </div>
      </main>
      <ChatButton />
